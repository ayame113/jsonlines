...
import {
  ...
  JSONLinesStream,
} from "https://deno.land/x/jsonlines@v0.0.5/mod.ts";
```
...
import {
  ConcatenatedJSONStream,
  JSONLinesStream,
} from "https://deno.land/x/jsonlines@v0.0.5/js/mod.js";
```
...
const { body } = await fetch(
  "https://deno.land/x/jsonlines@v0.0.5/testdata/json-lines.jsonl",
);
...
const { body } = await fetch(
  "https://deno.land/x/jsonlines@v0.0.5/testdata/json-seq.json-seq",
);
...
const { body } = await fetch(
  "https://deno.land/x/jsonlines@v0.0.5/testdata/concat-json.concat-json",
);
